...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO coupon_reg (name,email,message) VALUES ('$name','$email','$message')";
    $query = mysql_query($sql) or die(mysql_error());
    echo '<div class="alert alert-success"><h1> CONGRATULATIONS, YOU HAVE BEEN REGISTERED SUCCESSFULLY FOR BIG BELLY COUPON PRIVILEDGE<br> <a href="index.html">GO BACK HOME TO ORDER FOR YOUR BIG BELLY CHOW</a> </h1></div>';
